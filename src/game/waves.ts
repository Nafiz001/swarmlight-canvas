...
export const WAVE_TABLE: readonly WavePhase[] = [
  { from: 0, to: 45, interval: 0.75, pack: 1, weights: [['drifter', 1]] },
  { from: 45, to: 110, interval: 0.5, pack: 1, weights: [['drifter', 4], ['mite', 2]] },
  {
    from: 110,
    to: 180,
    interval: 0.38,
...
export const SURGES: readonly SurgeEvent[] = [
  { t: 90, label: 'Mite swarm', kind: 'mite', count: 36 },
  { t: 215, label: 'Darter pack', kind: 'darter', count: 14 },
  { t: 335, label: 'The walls close in', kind: 'drifter', count: 50 },
  { t: 455, label: 'Splinter tide', kind: 'splitter', count: 22 },
  { t: 530, label: 'Last hour of dark', kind: 'mite', count: 70 },
];
...
/** Enemy HP multiplier; reaches ~9x by 10:00. */
